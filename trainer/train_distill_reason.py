...
if __name__ == "__main__":
    ...
    parser.add_argument("--device", type=str, default="mps:0" if torch.backends.mps.is_available() else "cpu", help="训练设备")
    ...
    dtype = torch.float16  # MPS不支持bfloat16，直接使用float16
    autocast_ctx = torch.amp.autocast() if device_type == "mps" else nullcontext()
